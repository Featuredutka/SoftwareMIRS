...
_BUR_PUBLIC void
UtcDT_TO_LocalDTStructure(struct UtcDT_TO_LocalDTStructure *inst);
_BUR_PUBLIC void
LocalDT_TO_UtcDTStructure(struct LocalDT_TO_UtcDTStructure *inst);
_BUR_PUBLIC void
UtcDTStructure_TO_LocalDT(struct UtcDTStructure_TO_LocalDT *inst);
_BUR_PUBLIC void
LocalDTStructure_TO_UtcDT(struct LocalDTStructure_TO_UtcDT *inst);
...
_BUR_PUBLIC unsigned long ascTIMEStructure(unsigned long pTIMEStructure,
                                           unsigned long pStr,
                                           unsigned long len);
_BUR_PUBLIC unsigned long ascDTStructure(unsigned long pDTStructure,
                                         unsigned long pStr, unsigned long len);
_BUR_PUBLIC unsigned long ascTIME(plctime TIME1, unsigned long pStr,
                                  unsigned long len);
_BUR_PUBLIC unsigned long ascDT(plcdt DT1, unsigned long pStr,
                                unsigned long len);
_BUR_PUBLIC plctime TIMEStructure_TO_TIME(unsigned long pTIMEStructure);
_BUR_PUBLIC unsigned long TIME_TO_TIMEStructure(plctime TIME1,
                                                unsigned long pTIMEStructure);
_BUR_PUBLIC plcdt DTStructure_TO_DT(unsigned long pDTStructure);
_BUR_PUBLIC unsigned long DT_TO_DTStructure(plcdt DT1,
                                            unsigned long pDTStructure);
